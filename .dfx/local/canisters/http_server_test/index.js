...
import { idlFactory } from './http_server_test.did.js';
export { idlFactory } from './http_server_test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HTTP_SERVER_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./http_server_test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the http_server_test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./http_server_test.did.js")._SERVICE>}
 */
export const http_server_test = createActor(canisterId);
