...
import { idlFactory } from './http_demo.did.js';
export { idlFactory } from './http_demo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HTTP_DEMO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./http_demo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the http_demo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./http_demo.did.js")._SERVICE>}
 */
export const http_demo = createActor(canisterId);
